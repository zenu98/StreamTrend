      ...
      <div className="mx-auto px-4 md:px-8 py-10">
        ...
        <div className="mt-6  pt-6">
          <p className="text-xs leading-relaxed text-white/30">
            StreamTrend(스트림트렌드)는 치지직에 공개된 방송 데이터를
            수집·집계하여 보여주는 비공식 서비스입니다. 회원가입이나 로그인 없이
            이용할 수 있으며, 별도로 개인정보를 수집하지 않습니다.
          </p>

          <p className="text-xs leading-relaxed text-white/30">
            표시되는 게임/스트리머명, 이미지 등은 각 권리자에게 귀속되며,
            StreamTrend(스트림트렌드)는 정보 제공 목적으로만 이를 사용합니다.
            수집된 데이터의 정확성은 보장되지 않으며, 실제 치지직 수치와 오차가
            있을 수 있습니다.
          </p>
